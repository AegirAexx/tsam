...
__To install the program run:__

    make

__To uninstall the program run:__
...
The program takes three arguements in this order, IP, Low Port and High Port. To execute, run:

    sudo ./scanner [Destination IP Address] [Low Port] [High Port]

    sudo ./scanner 130.208.243.61 4000 4100


__Shortcuts to run the program on skel.ru.is:__
