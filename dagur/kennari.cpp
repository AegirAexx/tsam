...
int main (void)
{
    ...
    // Ég sendi pakka, fæ svar með checksum-i og þá þyrfti ég að lesa það checksum og búa til nýjan pakka sem fyllir upp í það checksum.
    // Væntanlega með því að fylla inn X mikið af data til að uppfylla checksum-ið
